...
<div class="content-wrapper">
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="row g-3" id="actticuenta">
                <!--onSubmit="return validarPasswd()" -->
                <div class="col-md-6">
                        <label for="inputTipCuenta" class="form-label">Tipo de cuenta</label>
                        <input type="text" class="form-control" id="inputTipCuenta" name="inputTipCuenta" required>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" id="btnactualizar" onclick="acttipcuenta()" name="btnactualizar" value="actualizar" class="btn btn-primary ">Actualizar</button>
  ...
  <div class="modal fade bd-example-modal-lg" id="nuevo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form class="row g-3" id="inscuenta" >
                    <div class="col-md-6">
                        <label for="inputTipCuenta" class="form-label">Tipo de cuenta</label>
                        <input type="text" class="form-control" id="inputTipCuenta" name="inputTipCuenta" required>
                    </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" id="btnagregar" name="btnagregar" onclick="instipcuenta()" value="agregar" class="btn btn-primary ">Crear</button>
...
<!-- /modal nuevo usuario -->
    <script>
      function Buscarcuenta() {
        ...
        $.ajax({
          ...
          url: 'catalogos/ingcuenta_query.php', //archivo que recibe la peticion
    ...
    function instipcuenta() { 

      var datos = $('#inscuenta').serialize();
      $.ajax({
        type: "POST",
        url: "catalogos/crud_ingcuenta.php",
        data: datos,
        beforeSend: function() {
    ...
    function acttipcuenta() {

      var datos = $('#actticuenta').serialize();
      $.ajax({
        type: "POST",
        url: "catalogos/crud_ingcuenta.php", 
        data: datos,
