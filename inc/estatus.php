...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1><strong>Estatus de viaje</strong></h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="row g-3" id="actestatus">
                ...
                <div class="col-md-12">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" id="btnactualizar" onclick="acttestatus()" name="btnactualizar" value="actualizar" class="btn btn-primary ">Actualizar</button>
...
<!-- /modal nuevo usuario -->
    <script>
      function Buscarcuenta() {
        ...
        $.ajax({
          ...
          url: 'catalogos/estatus_query.php', //archivo que recibe la peticion
    ...
    function instimov() { 
      ...
      $.ajax({
        type: "POST",
        url: "catalogos/crud_estatus.php",
        data: datos, 
        beforeSend: function() {
