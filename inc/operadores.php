...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1><strong>Operadores</strong></h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
        ...
        <div class="row ">
          ...
          <div class="form-group col-sm-2">
            <?PHP if ($_SESSION['add_cobranza'] == "1") { ?>
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevo">Nuevo operador</button>
            <?php } ?>
          </div>
        </div>
  ...
  <div class="modal fade bd-example-modal-lg" id="nuevo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form class="row g-3" id="insoperador" >
                      <div class="col-md-6">
                        <label for="inputNombre" class="form-label">Nombre</label>
                        <input type="text" class="form-control" id="inputNombre" name="inputNombre" required>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" id="btnagregar" name="btnagregar" onclick="insoperador()" value="agregar" class="btn btn-primary ">Crear</button>
...
<!-- /modal nuevo usuario -->
    <script>
      function BuscarOperador() {
        ...
        $.ajax({
          ...
          url: 'catalogos/operador_query.php', //archivo que recibe la peticion
    ...
    function insoperador() { 
      ...
      $.ajax({
        type: "POST",
        url: "catalogos/crud_operador.php",
        data: datos,
        beforeSend: function() {
