...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1><strong>Tipos de documentos</strong></h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="row g-3" id="actdocum">
                <!--onSubmit="return validarPasswd()" -->
                <div class="col-md-12">
                        <label for="inputEstatus" class="form-label">Tipo de documentos</label>
                        <input type="text" class="form-control" id="inputDoc" name="inputDoc" required>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" id="btnactualizar" onclick="actdocum()" name="btnactualizar" value="actualizar" class="btn btn-primary ">Actualizar</button>
  ...
  <div class="modal fade bd-example-modal-lg" id="nuevo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" id="btnagregar" name="btnagregar" onclick="insdoc()" value="agregar" class="btn btn-primary ">Crear</button>
...
<!-- /modal nuevo usuario -->
    <script>
      function Buscarcuenta() {
        ...
        $.ajax({
          ...
          url: 'catalogos/documento_query.php', //archivo que recibe la peticion
    ...
    function insdoc() { 
      ...
      var datos = $('#insdoc').serialize();
      $.ajax({
        type: "POST",
        url: "catalogos/crud_documento.php",
        data: datos, 
        beforeSend: function() {
